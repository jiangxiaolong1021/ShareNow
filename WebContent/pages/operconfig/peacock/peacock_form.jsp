					...
					<div class="form-group has-success">
						...
						<div class="controls">
							<img id="imageFrontOld" class="thumbnail" height="80px"
								width="120px" src="" /> <input type="file" id="zm"
								name="myfiles" class="form-control col-lg-2" /> <input
								type="hidden" name="path" id="path" value=""> <input
								type="button" value="上传文件" onclick="ajaxFileUpload()"
